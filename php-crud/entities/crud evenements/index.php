...
<?php endif ?>
	...
	?>
	<div class="row justify-content-center">
		<form action="process.php" method="POST" id="myTable">
		...
		<div class="form-group">
		<label> Location </label><span class="error">* <?php echo $locationErr;?></span>
		<input type="text" name="Location" class="form-control" value="<?php echo $location; ?>" placeholder="enter your location" required>
		
		</div>
		<div class="form-group">
		<label> Date_event </label><span class="error">* <?php echo $date_eventErr;?></span>
		<input type="text" name="Date_event" class="form-control" value="<?php echo $date_event; ?>" placeholder="enter the date of your event" required>
