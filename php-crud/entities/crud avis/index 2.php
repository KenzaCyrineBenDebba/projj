...
<!-- <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
	...
	<?php require_once 'process 2.php'; ?> 
	<?php 
...
<?php endif ?>
	...
	<?php
	  ...
	  $result =$mysqli->query("SELECT * FROM avis") or die($mysqli->error);
	  //pre-r($result);
	...
	<div class="row justify-content-center">
		<form action="process 2.php" method="POST" id="myTable">
		...
		<input type="text" name="feedback" class="form-control"  value="<?php echo $feedback; ?>" placeholder="enter your feedback" required>
