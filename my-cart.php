...
<div class="logo">
            <img id="enove-logo" src="assets\images\logo-2-blanc.ico"> </div>
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="#<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['productName'];
